...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => <div ref={ref} className={clsx("rounded-[var(--loam-radius-lg)] border border-[var(--loam-ink)] bg-[var(--loam-surface)] text-[var(--loam-ink)] shadow-[4px_5px_0_var(--loam-ink)] transition-[transform,box-shadow] duration-300 ease-[var(--loam-ease-spring)] hover:-translate-y-1 hover:-rotate-[.35deg] hover:shadow-[7px_9px_0_var(--loam-ink)] motion-reduce:transform-none motion-reduce:transition-none", className)} {...props} />)
